...
public class TickerProvider extends ContentProvider{
    ...
    private static final String CREATE_TICKERURL_TABLE_SQL = "CREATE TABLE" + " " +
            ...
            TickerProviderContract.TICKER_BID_COLUMN + " " + TEXT_TYPE + " ," +
            TickerProviderContract.TICKER_ASK_COLUMN + " " + TEXT_TYPE + " ," +
            TickerProviderContract.TICKER_VWAP_COLUMN + " " + TEXT_TYPE + " ," +
            TickerProviderContract.TICKER_VOLUME_COLUMN + " " + TEXT_TYPE +
            ")";
    ...
    static {
        ...
        sUriMatcher.addURI(
                TickerProviderContract.AUTHORITY,
                TickerProviderContract.TICKER_TABLE_NAME,
                TICKER_URL_QUERY);
    ...
    private class TickerProviderHelper extends SQLiteOpenHelper {
        ...
        TickerProviderHelper(Context context) {
            super(context,
                    TickerProviderContract.DATABASE_NAME,
                    null,
                    TickerProviderContract.DATABASE_VERSION);
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int version1, int version2) {
            Log.w(TickerProviderHelper.class.getName(),
