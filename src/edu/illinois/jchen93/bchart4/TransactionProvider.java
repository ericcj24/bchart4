...
public class TransactionProvider extends ContentProvider {
	...
	private static final String CREATE_TRANSACTIONURL_TABLE_SQL = "CREATE TABLE" + " " + TransactionProviderContract.TRANSACTION_TABLE_NAME
	...
	static {
		...
		sUriMatcher
		        .addURI(TransactionProviderContract.AUTHORITY, TransactionProviderContract.TRANSACTION_TABLE_NAME, TRANSACTION_URL_QUERY);

		// Specifies a custom MIME type for the picture URL table
		sMimeTypes.put(TRANSACTION_URL_QUERY, "vnd.android.cursor.dir/vnd." + TransactionProviderContract.AUTHORITY + "."
	...
	private class TransactionProviderHelper extends SQLiteOpenHelper {
		...
		TransactionProviderHelper(Context context) {
			super(context, TransactionProviderContract.DATABASE_NAME, null, TransactionProviderContract.DATABASE_VERSION);
		}
		...
		public void onUpgrade(SQLiteDatabase db, int version1, int version2) {
			Log.w(TransactionProviderHelper.class.getName(), "Upgrading database from version " + version1 + " to " + version2
		...
		public void onDowngrade(SQLiteDatabase db, int version1, int version2) {
			Log.w(TransactionProviderHelper.class.getName(), "Downgrading database from version " + version1 + " to " + version2
			        + ", which will destroy all the existing data");
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
		...
		Cursor returnCursor = db.query(TransactionProviderContract.TRANSACTION_TABLE_NAME, projection, selection, selectionArgs, null,
		        null, sortOrder);
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		long id = localSQLiteDatabase.insert(TransactionProviderContract.TRANSACTION_TABLE_NAME, null, values);
	...
	public int bulkInsert(Uri uri, ContentValues[] insertValuesArray) {
		...
		for (int i = 0; i < numTransactions; i++) {
			...
			localSQLiteDatabase.insert(TransactionProviderContract.TRANSACTION_TABLE_NAME, null, insertValuesArray[i]);
		}
	...
	public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
		...
		// Updates the table
		int rows = localSQLiteDatabase.update(TransactionProviderContract.TRANSACTION_TABLE_NAME, values, selection, selectionArgs);
